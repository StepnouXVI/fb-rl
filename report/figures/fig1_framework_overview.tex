...
% State feedback arrow cleanly routed along bottom of policy
\draw[darr=themeblue] (f_s.west) -- ++(-0.35, 0) |- ([yshift=-4pt]f_pil.west) 
    node[pos=0.25, left=1pt, font=\scriptsize\bfseries, text=themeblue!90!black] {$s_t$};

% ==============================================================================
% BOTTOM UNIFIED COMPARISON BANNER
% ==============================================================================
\node[pill=themegray, font=\footnotesize, minimum width=17.5cm, inner sep=6pt] at (8.5, -3.1) 
