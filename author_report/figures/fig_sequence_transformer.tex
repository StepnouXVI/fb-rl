...
\begin{tikzpicture}[>=stealth, font=\small, scale=0.88, every node/.style={transform shape}]
    ...
    \node[draw=purple!80, fill=purple!20, rounded corners=5pt, minimum width=8.5cm, minimum height=1.1cm, align=center] (cross_attn) at (5.0, 0.4) {\textbf{Multi-Head Cross-Attention с ALiBi штрафом}\\$\text{Attn}(Q, K) = \text{Softmax}\left(\frac{Q K^\top}{\sqrt{d}} - \lambda \cdot m_h \cdot [0, 1, 2, \dots]\right)$};
